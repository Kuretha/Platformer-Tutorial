...
public class Playing extends State implements Statemethods{
	...
	public void update() {
		if (paused){
			...
			levelManager.update();
			objectManagaer.update(levelManager.getCurrentLevel().getLvlData(), player);
			player.update();
...
//		reset playing, enemy, lvl etc
	...
	public void checkSpikesTouched(Player p) {
		objectManagaer.checkSpikesTouched(p);
	}
	...
	public void setLevelCompleted(boolean levelCompleteed) {
		this.lvlCompleted = levelCompleteed;
		if (levelCompleteed)
